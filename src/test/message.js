...
const obj = 'spadeanspade'
const obj_2 = 'thunderbolts'
...
describe('Message API endpoints', () => {
    ...
    it('should post a new message', (done) => {
        chai.request(app)
        .post('/messages')
        .send({title: 'anothertesttitle', body: 'anothertestbody', author: mongoose.Types.ObjectId(obj)})
        .end((err, res) => {
            if (err) { done(err) }
